...
<script src="<?php echo base_url('/'); ?>js/my-script.js?v=<?php echo get_file_info(FCPATH.'js'.DS.'my-script.js')['date']; ?>"></script>
<?php if( read_file(FCPATH.'js'.DS.$class.'-'.$method.'.js') !== FALSE ): ?>
<script src="<?php echo base_url('/'); ?>js/<?php echo $class; ?>-<?php echo $method; ?>.js?v=<?php echo get_file_info(FCPATH.'js'.DS.$class.'-'.$method.'.js')['date']; ?>"></script>
<?php endif; ?>
</body>
</html>