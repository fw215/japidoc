	...
	<div class="wrapper" id="main-container">
		<header class="main-header">
			<a href="<?php echo base_url('/'); ?>" class="logo">
				<span class="logo-mini"><b><?php echo lang('app_title_mini'); ?></b></span>
				<span class="logo-lg"><b><?php echo lang('app_title'); ?></b></span>
			</a>
					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu">
							<a href="<?php echo base_url('/login/logout'); ?>" class="dropdown-toggle">
								<span class=""><?php echo lang('logout_title'); ?></span>
							</a>
						</li>
					</ul>
				</div>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				<ul class="sidebar-menu" data-widget="tree">
					<li class="header"><?php echo lang('app_aside_header'); ?></li>
<?php foreach($aside as $side): ?>
<?php if($side['children']): ?>
					<li class="treeview <?php if($class == $side['class']): ?>active<?php endif; ?>">
						<a href="#"><?php echo $side['icon']; ?> <span><?php echo $side['name']; ?></span>
...
<?php else: ?>
					<li class="<?php if($class == $side['class']): ?>active<?php endif; ?>">
						<a href="<?php echo base_url('/').$side['link']; ?>">
							<?php echo $side['icon']; ?> <span><?php echo $side['name']; ?></span>
						</a>
					</li>
<?php endif; ?>
<?php endforeach; ?>
