...
$lang['form_validation_required']		= '{field}は必須です';//'{field}欄は必須フィールドです';
$lang['form_validation_isset']			= '{field}欄は値がなければいけません';
$lang['form_validation_valid_email']		= '{field}は正しい形式で入力してください';//'{field}は正しい形式でなければいけません';
$lang['form_validation_valid_emails']		= '{field}欄は正しいメールアドレスでなければいけません';
$lang['form_validation_valid_url']		= '{field}は正しい形式で入力してください';//'{field}欄は正しいURLでなければいけません';
$lang['form_validation_valid_ip']		= '{field}欄は正しいIPアドレスだければいけません';
$lang['form_validation_min_length']		= '{field}は{param}文字以上で入力してください';//'{field}欄は{param}文字以上でなければいけません';
$lang['form_validation_max_length']		= '{field}は{param}文字以下で入力してください';//'{field}欄は{param}文字以下でなければいけません';
...
$lang['form_validation_is_natural_no_zero']	= '{field}は必須です';//'{field}欄はゼロより大きい数値のみです。';
$lang['form_validation_decimal']		= '{field}は小数点を含めた数値を入れてください';//'{field}欄は10進数のみです。';
$lang['form_validation_less_than']		= '{field}欄は{param}より小さい値で入力してください。';//'{field}欄は{param}より小さい値でなければいけません。';
$lang['form_validation_less_than_equal_to']	= '{field}欄は{param}以下の値でなければいけません。';
$lang['form_validation_greater_than']		= '{field}は{param}より大きい値で入力してください。';//'{field}欄は{param}より大きい値でなければいけません。';
